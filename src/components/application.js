...
export function Application({ user, popupMsg, popup, setLoading }) {
  ...
  function getallurls() {
    fetch("https://urlshortnerbackend-production.up.railway.app/", {
      ...
      .catch((err) => {
        console.log("erron on login", err.message);
      });
  }
                ...
                <>
                  <div>
                    ...
                    <div id="short">
                      ...
                      <a
                        href={
                          "https://urlshortnerbackend-production.up.railway.app/" +
                          v.short
                        }
                        rel="noreferrer" 
                        target="_blank"
